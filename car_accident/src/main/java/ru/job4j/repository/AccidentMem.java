...
public class AccidentMem implements AccidentStore {
    ...
    public AccidentMem() {
        ...
        this.store = new HashMap<>() {                 // TODO remove stub data
            {
                put(index.getAndIncrement(), Accident.newBuilder().setId(1).setName("name 1").setText("text 1").setAddress("address 1").build());
                put(index.getAndIncrement(), Accident.newBuilder().setId(2).setName("name 2").setText("text 2").setAddress("address 2").build());
                put(index.getAndIncrement(), Accident.newBuilder().setId(3).setName("name 3").setText("text 3").setAddress("address 3").build());
            }
        };
